...
//These are considered "action types" 
// we do it like this in the caes that the programmer spells it wrong...it won't alert you if its a string
...
function reducer( state = initialState, action ) {
    switch( action.type ){
        ...
        case UPDATE_PROP:
            return Object.assign( {}, state, {propertyToBeUsedOn: action.payload });
...
// These are considered action creators
